...
def run_model(n_bootstraps, file, model0, model1, machine, intervention, outcome, include_propensity, undersampled = False, num_iter = 1):
...
def run_model_class(n_bootstraps, file, model0, model1, machine, intervention, outcome, include_propensity, undersampled = False, num_iter = 1):
    # if more iterations are necessary
